...
public class ApricotParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Apricot");
  ...
  { 
    ApricotParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ApricotParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ApricotParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ApricotParseControllerGenerated.class);
    }
  ...
  { 
    return ApricotParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
